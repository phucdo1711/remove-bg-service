...
from routes import  cartoonize_api, photo2cartoon_api, remove_bg_api,portrait_sketch_api,style_transfer_api
...
APP.register_blueprint(photo2cartoon_api.get_blueprint())
APP.register_blueprint(cartoonize_api.get_blueprint())

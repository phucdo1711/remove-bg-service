...
import styles from "./RemoveBgPage.module.scss";
        ...
        {file && (
          <Col sm={24} md={12} className={styles.col}>
            <ResultImage
              ...
              title="u2net (animal, human, object,...)"
            />
            ...
            <ResultImage
              ...
              uploadFnc={async (file) => {
                ...
                formData.append("file", file);
                const res = await axios.post(
                  "/api/remove-bg?model=u2net_human_seg",
                  formData,
                  {
                    headers: {
                      "content-type": "multipart/form-data",
